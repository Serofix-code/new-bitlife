...
Next Chapter is built with HTML, CSS, and JavaScript. It has no runtime package dependencies, advertising, analytics, or required online account.

## License

This project is available under the included source-available non-commercial license. See `LICENSE.md` for the complete terms.
